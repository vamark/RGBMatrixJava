#include "dev_vagvolgyi_rgbmatrix_jni_RGBMatrixJNI.h"
...
JNIEXPORT jlong JNICALL Java_dev_vagvolgyi_rgbmatrix_jni_RGBMatrixJNI_createFromOptions(JNIEnv* env, jclass,
jobject options, jobject runtimeOptions) {
...
JNIEXPORT jobject JNICALL Java_dev_vagvolgyi_rgbmatrix_jni_RGBMatrixJNI_createFrameCanvas(JNIEnv* env,
jobject matrixJNI) {
...
JNIEXPORT jobject JNICALL Java_dev_vagvolgyi_rgbmatrix_jni_RGBMatrixJNI_swapOnVSync(JNIEnv* env, jobject matrixJNI,
jobject canvasJNI, jint framerateFraction) {
...
JNIEXPORT void JNICALL Java_dev_vagvolgyi_rgbmatrix_jni_RGBMatrixJNI_setBrightness(JNIEnv* env, jobject matrixJNI,
jint brightness) {
    RGBMatrixBridge(env).toNative(matrixJNI)->SetBrightness(brightness);
}

JNIEXPORT jint JNICALL Java_dev_vagvolgyi_rgbmatrix_jni_RGBMatrixJNI_getBrightness(JNIEnv* env, jobject matrixJNI) {
    return RGBMatrixBridge(env).toNative(matrixJNI)->brightness();
}

JNIEXPORT void JNICALL Java_dev_vagvolgyi_rgbmatrix_jni_RGBMatrixJNI_startRefresh(JNIEnv* env, jobject matrixJNI) {
    RGBMatrixBridge(env).toNative(matrixJNI)->StartRefresh();
}

JNIEXPORT void JNICALL Java_dev_vagvolgyi_rgbmatrix_jni_RGBMatrixJNI_close(JNIEnv* env, jobject matrixJNI) {
