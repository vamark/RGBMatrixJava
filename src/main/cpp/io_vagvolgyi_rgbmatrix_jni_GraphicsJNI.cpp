...
JNIEXPORT jint JNICALL Java_io_vagvolgyi_rgbmatrix_jni_GraphicsJNI_drawText(JNIEnv* env, jclass, jobject canvasJNI, jobject fontJNI, jint x, jint y, jobject colorJNI, jobject backgroundColorJNI, jstring text, jint kerningOffset) {
    FrameCanvas* canvas;
    Font* font;
    Color color;
    ...
    prepareTextDrawing(env, canvasJNI, fontJNI, colorJNI, backgroundColorJNI, text, canvas, font, color, backgroundColor, textChars);
...
JNIEXPORT jint JNICALL Java_io_vagvolgyi_rgbmatrix_jni_GraphicsJNI_verticalDrawText(JNIEnv* env, jclass, jobject canvasJNI, jobject fontJNI, jint x, jint y, jobject colorJNI, jobject backgroundColorJNI, jstring text, jint kerningOffset) {
    FrameCanvas* canvas;
    Font* font;
    Color color;
    Color* backgroundColor;
